...
import (
	...
	"github.com/cosmostation/mintstation/docs"
)
...
func New(
	...
	*/
	...
	mintstationPrefix := sdk.GetConfig().GetBech32AccountAddrPrefix()
	wasmHooks := ibchooks.NewWasmHooks(app.IBCHooksKeeper, &app.WasmKeeper, mintstationPrefix) // The contract keeper needs to be set later
	...
	app.MnsKeeper = *mnsmodulekeeper.NewKeeper(
		appCodec,
		keys[mnsmoduletypes.StoreKey],
		keys[mnsmoduletypes.MemStoreKey],
		app.GetSubspace(mnsmoduletypes.ModuleName),
	)
	mnsModule := mnsmodule.NewAppModule(appCodec, app.MnsKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(mnsmoduletypes.ModuleName)
